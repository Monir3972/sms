...
switch ($param)
{
        ...
        case '4': 
            $sql = 'SELECT *,(SELECT name from departments WHERE id=`dept_id`) as dept_name,(SELECT name from sections WHERE id=`section_id`) as sec_name FROM students ORDER BY id DESC';
